...
import novitaLogo from "../assets/novita.png"
...
function normalizeProvider(value: string): string {
  ...
  if (normalized.includes("zenmux")) return "zenmux"
  return "fallback"
}
