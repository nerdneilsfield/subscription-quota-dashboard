...
const MESSAGES = {
  en: {
    ...
    viewUsageHistory: "Usage history",
    subscriptionHistory: "SUBSCRIPTION HISTORY",
    usageHistory: "Usage history",
    percentUsedHistory: "Used percentage",
    historyChartAria: "{label} usage history chart",
    historyNotEnoughData: "History is still accumulating. At least two successful samples are required.",
    scheduledSamples: "scheduled samples",
  ...
  "zh-CN": {
    ...
    viewUsageHistory: "用量趋势",
    subscriptionHistory: "订阅用量历史",
    usageHistory: "用量趋势",
    percentUsedHistory: "已用比例",
    historyChartAria: "{label} 用量历史折线图",
    historyNotEnoughData: "历史数据仍在积累，至少需要两次成功采样。",
    scheduledSamples: "定时采样",
